...
- FAQセクション：まとめの一つ前にFAQセクションを設ける。記事のキーワードに関連した質問を3〜4個生成する。フォーマット：Q&Aに##・###見出しは使わない／**Q. 質問文** の形式で太字にする／A. 回答文 は平文で書く／Q&Aの間に空行を入れる
...
- ののかコメント：各H2セクションの末尾に吹き出しを追加する。その見出しの内容に関連した一言を、ののか口調（明るく親しみやすい話し言葉）で書く
- FAQセクション：まとめの一つ前にFAQセクションを設ける。記事内容に関連した質問を3〜4個生成する。フォーマット：Q&Aに##・###見出しは使わない／**Q. 質問文** の形式で太字にする／A. 回答文 は平文で書く／Q&Aの間に空行を入れる
- summary-boxの箇条書きルール：「この記事でわかること」は1項目20字以内・3項目まで、「こんな人におすすめ」は1項目15字以内・3項目まで、末尾の「この記事のまとめ」ボックスは1項目25字以内・3項目まで
...
- FAQセクション：まとめの一つ前にFAQセクションを設ける。比較記事のキーワードに関連した質問を3〜4個生成する。フォーマット：Q&Aに##・###見出しは使わない／**Q. 質問文** の形式で太字にする／A. 回答文 は平文で書く／Q&Aの間に空行を入れる
- summary-boxの箇条書きルール：「この記事でわかること」は1項目20字以内・3項目まで、「こんな人におすすめ」は1項目15字以内・3項目まで、末尾の「この記事のまとめ」ボックスは1項目25字以内・3項目まで
